...
res_box = 'experiment_group2_final_allEAs.csv'#prob need to combine
...
ax = sns.boxplot(x='EA', y='Gain', data=df).set(title='Group A')#-----------------------per enemy group
plt.ylim(-500, 0)
...
plt.savefig('box_g2A_allEAs_lim0.png')
